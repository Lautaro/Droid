...
#region Create
	...
	static T Add<T> () where T : MonoBehaviour
	{
	 ...
	 static bool ortographic =  UICamera.list[0].GetComponent<Camera>().orthographic;
	...
	static bool Create2Da () { return UIRoot.list.Count == 0 || UICamera.list.size == 0 || !ortographic; }
	...
	static bool Create3Da () { return UIRoot.list.Count == 0 || UICamera.list.size == 0 || ortographic; }
